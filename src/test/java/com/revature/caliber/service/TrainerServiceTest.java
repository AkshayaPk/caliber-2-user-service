...
public class TrainerServiceTest {
	...
	public void setUp() throws Exception {
		...
		when(dao.findOne(11)).thenReturn(null);
	}
	...
	public void testGetTrainerById() {
		assertEquals("Testing get trainer by id method", trainerOne, tsi.getTrainerById(1));
	}
	
	@Test
	public void testGetTrainerByNullId() {
		assertNull("Testing passing in an id that does not exist", tsi.getTrainerById(11));
	}
