...
public class Trainee implements Serializable {
	...
	public String toString() {
		return "Trainee [traineeId=" + traineeId + ", resourceId=" + resourceId + ", name=" + name + ", email=" + email
				...
				+ ", flagNoteTimestamp=" + flagNoteTimestamp + "]" + ", flagNoteAuthor=" + flagNoteAuthor + "]";
	}
	...
	public String getFlagAuthor() {
		return flagNoteAuthor;
	}

	public void setFlagAuthor(String author) {
	...
	public void setFlagTimestamp(String timestamp) {
